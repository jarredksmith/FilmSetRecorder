...
Write-Host "=== FilmSet Recorder 0.7.1 Windows Builder ===" -ForegroundColor Cyan
...
Write-Host "Installer: release\FilmSetRecorder_Setup_0.7.1.exe" -ForegroundColor Green
