...
5. When the run finishes, download `FilmSetRecorder-Windows-Installer-v0.2.0` from **Artifacts**.
6. Unzip it and install `FilmSetRecorder_Setup_0.2.0.exe`.
...
4. Download `FilmSetRecorder-macOS-v0.2.0` from **Artifacts**.
