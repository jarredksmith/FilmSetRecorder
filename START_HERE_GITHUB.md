...
5. When the run finishes, download `FilmSetRecorder-Windows-Installer-v0.4.0` from **Artifacts**.
6. Unzip it and install `FilmSetRecorder_Setup_0.4.0.exe`.
...
4. Download `FilmSetRecorder-macOS-v0.4.0` from **Artifacts**.
