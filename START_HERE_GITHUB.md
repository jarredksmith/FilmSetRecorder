...
5. Download `FilmSetRecorder-Windows-Installer-v0.5.0` from **Artifacts**.
6. Unzip it and install `FilmSetRecorder_Setup_0.5.0.exe`.
...
5. Download the artifact matching the Mac:
   - `FilmSetRecorder-macOS-v0.5.0-arm64` for Apple Silicon (M-series)
   - `FilmSetRecorder-macOS-v0.5.0-x86_64` for Intel
