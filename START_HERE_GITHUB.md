...
5. When the run finishes, download `FilmSetRecorder-Windows-Installer-v0.3.0` from **Artifacts**.
6. Unzip it and install `FilmSetRecorder_Setup_0.3.0.exe`.
...
4. Download `FilmSetRecorder-macOS-v0.3.0` from **Artifacts**.
