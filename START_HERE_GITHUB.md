...
5. Download `FilmSetRecorder-Windows-Installer-v0.6.3` from **Artifacts**.
6. Unzip it and install `FilmSetRecorder_Setup_0.6.3.exe`.
...
5. Download the artifact matching the Mac:
   - `FilmSetRecorder-macOS-v0.6.3-arm64` for Apple Silicon (M-series)
   - `FilmSetRecorder-macOS-v0.6.3-x86_64` for Intel
